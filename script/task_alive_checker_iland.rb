...
@@schedule2_name = @@config["task_checker_file"] + "_iland"
aFile = File.new(@@schedule2_name,"r")
...
#    `/etc/init.d/httpd restart`
    `/usr/local/bin/ruby /var/www/gdevvdi/script/ilandcommand.rb stop`
    `/usr/local/bin/ruby /var/www/gdevvdi/script/ilandcommand.rb start`
