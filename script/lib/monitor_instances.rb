...
class MonitorInstances  
  ...
  def power_off_by_cpu_usage(cpu_usage = 5, duration = 3600)
    ...
    each_machine_with_cpu_usage(cpu_usage, duration) do |instance_id, region|
  ...
  def power_off_by_data_send_out(data_size = 100, duration = 3600)
    ...
    each_machine_with_data_send_out(data_size, duration) do |instance_id|
  ...
  def each_machine_with_data_send_out(data_size, duration)
    each_active_machine do |instance_id, region|
