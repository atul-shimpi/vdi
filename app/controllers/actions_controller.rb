class ActionsController < ApplicationController
  ...
  # GET /actions/1/edit
  def edit
    @edit_action = Action.find(params[:id])
  end

  # POST /actions
  # POST /actions.xml
  def create
    @action = Action.new(params[:new_action])
  ...
  def update
    @action = Action.find(params[:id])
    @action.action = params[:edit_action_action]
    @action.controller = params[:edit_action_controller]
    @action.description = params[:edit_action_description]
